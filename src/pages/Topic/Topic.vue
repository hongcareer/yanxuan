<template>
  <div >
    <div class="topic">
      ...
      <div class="scroll">
        <div class="menu" v-if="$route.params.id == '9'">
        ...
        <div class="talk" v-if="$route.params.id == '7'">
          <ul class="t-list">
            <li v-for="(talk,index) in totalTalk.topicList" :key="index">
              <img :src="talk.bannerInfo.picUrl" alt="" class="bigPic">
              <span class="title">{{talk.content}}</span>
              <div class="hed">
                <span class="litPic">
                  <img :src="talk.avatar" alt="">
                </span>
                <span class="left">{{talk.nickName}}</span>
                <span class="right">{{talk.supportNum}}赞</span>
              </div>
            </li>
          </ul>
        </div>
  ...
  export default {
    ...
    computed:{
      ...mapState({
        ...
        totalTalk:state => state.talk.totalTalk
      }),
    },
    methods:{
      _initScroll(){
